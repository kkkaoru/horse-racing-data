...
| Rows exist but `prediction_generated_at` is hours old         | Do not redeploy. Work entrance: `handoff-weight-rescore-20260816.md`.                                                                                                                                     | that handoff (not the older observe-plan first)                                                                                               |
...
- Weight trigger stall: start at `handoff-weight-rescore-20260816.md`.
