...
**Also observation, not a cause (n=2):** each landing sat **after** a
Container 503 (01/02: 10:19–10:20 then 10:54; 07/01: 12:55 then ~12:57).
Treat 503 as a **preceding event**, not as proof the slot stayed full.
