...
Updated 12:41 JST. Add Ban-ei later. Do **not** infer why 01/02 landed.
...
Same on the three JRA R1s + 35/01: no UPSERT before post, no
retry_errors row, odds still the morning **constant**.
