/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2bbaa68793ae8c5910452cc512d50d81)
// Runtime types generated with workerd@1.20260611.1 2026-09-02 nodejs_compat
interface __BaseEnv_Env {
  JV_LINK_STATE: R2Bucket;
  JRA_VAN_STATE_URL: "https://jra-van-datalab-cloudflare-demo.kaoru.workers.dev/internal/state";
  JV_LINK_CONTAINER: DurableObjectNamespace<import("./src/worker").JvLinkContainer>;
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./src/worker");
    durableNamespaces: "JvLinkContainer";
  }
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JRA_VAN_STATE_URL">> {}
}
