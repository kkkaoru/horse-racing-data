// Run with bun. Viewer-compatible pred:fp / pred:rs key, window, and TTL helpers.
...
export const raceYmdFromParts = (year: string, mmdd: string): string =>
  `${year}${padRacePart(mmdd, 4)}`;
