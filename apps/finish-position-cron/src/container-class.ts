...
//
// SLEEP_AFTER is "30m" (was "30s") so a focused per-race full request can
// return accepted and still leave enough container lifetime for the detached
// DuckDB+layer+scoring+Neon pipeline to finish.
...
// outlives a single worst-case focused pipeline run.
