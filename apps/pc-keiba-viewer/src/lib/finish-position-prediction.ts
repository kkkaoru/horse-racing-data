...
export const buildFinishPredictionRowsFromResults = ({
  ...
  // Race-level confidence tier / raw stddev: every model feature for this race
  ...
  const predictedScoreStddev = modelPredictionFeatures[0]?.predictedScoreStddev ?? null;
