...
const DOMESTIC_SIMILAR_DETAIL_SECTION_CACHE_VERSION = "v4";
...
const getDetailSectionCacheVersion = (
  ...
  if (section === "similar" && !isOverseasKeibajoCode(keibajoCode)) {
    return DOMESTIC_SIMILAR_DETAIL_SECTION_CACHE_VERSION;
  }
