...
> = {
  ...
  jra: {
    ...
    fromDate: "20160514",
    pairScore: 71.7,
    place1Accuracy: 38.54,
    place2Accuracy: 20.73,
    place3Accuracy: 15.71,
    raceCount: 58294,
    target: "local",
    toDate: "20260514",
    top1Accuracy: 38.54,
    top3BoxAccuracy: 12.49,
    top3ExactOrderAccuracy: 3.65,
    top3PlaceRelation: 56.73,
    top3WinnerCapture: 71.47,
    top5WinnerCapture: 86.15,
  },
  nar: {
    category: "nar",
    categoryLabel: "地方競馬",
    fromDate: "20160514",
    pairScore: 72.17,
    place1Accuracy: 43.74,
    place2Accuracy: 23.08,
    place3Accuracy: 17.44,
    raceCount: 132336,
    target: "local",
    toDate: "20260514",
    top1Accuracy: 43.74,
    top3BoxAccuracy: 15.81,
    top3ExactOrderAccuracy: 4.81,
    top3PlaceRelation: 61.02,
    top3WinnerCapture: 77.19,
    top5WinnerCapture: 90.78,
  },
};
