...
> = {
  ...
  jra: {
    ...
    fromDate: "20160514",
    pairScore: 71.73,
    place1Accuracy: 38.88,
    place2Accuracy: 20.92,
    place3Accuracy: 15.81,
    raceCount: 58294,
    target: "local",
    toDate: "20260514",
    top1Accuracy: 38.88,
    top3BoxAccuracy: 12.57,
    top3ExactOrderAccuracy: 3.75,
    top3PlaceRelation: 56.82,
    top3WinnerCapture: 71.53,
    top5WinnerCapture: 86.24,
  },
  nar: {
    category: "nar",
    categoryLabel: "地方競馬",
    fromDate: "20160514",
    pairScore: 72.17,
    place1Accuracy: 43.86,
    place2Accuracy: 23.13,
    place3Accuracy: 17.5,
    raceCount: 132336,
    target: "local",
    toDate: "20260514",
    top1Accuracy: 43.86,
    top3BoxAccuracy: 15.85,
    top3ExactOrderAccuracy: 4.82,
