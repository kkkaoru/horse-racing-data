...
const pickRunner = (runner: Runner) => ({
  ...
  horseNameFull: runner.horseNameFull,
  identitySource: runner.identitySource,
  jockeyNameFull: runner.jockeyNameFull,
  ...
  ownerNameFull: runner.ownerNameFull,
  ...
  trainerNameFull: runner.trainerNameFull,
