    ...
    "/api/finish-predictions/daily": {
      get: {
        ...
        parameters: [
          ...
          {
            description: "任意の競馬場コード。raceNumberと同時に指定すると1レースだけ返します。",
            in: "query",
            name: "keibajoCode",
            required: false,
            schema: { pattern: "^[0-9A-Z]{2}$", type: "string" },
          ...
          {
            description: "任意のレース番号。keibajoCodeと同時に指定すると1レースだけ返します。",
            in: "query",
            name: "raceNumber",
            required: false,
            schema: { pattern: "^\\d{2}$", type: "string" },
        ...
        summary: "指定日または指定レースの着順予測をcanonical raceId付きで返します。",
        tags: ["predictions"],
      },
    },
    ...
    "/api/races/{year}/{month}/{day}/{keibajoCode}/{raceNumber}/trends": {
      get: {
        ...
        parameters: [
          ...
          {
            description:
              "DBに未反映のリアルタイム結果を候補レースから補完するか。false の場合のみ補完しません。",
            in: "query",
          ...
          {
            description: "レース番号を脚質傾向の集計条件から外すか。",
            in: "query",
            name: "runningStyleIgnoreRaceNumber",
            required: false,
            schema: { default: true, type: "boolean" },
          },
          {
