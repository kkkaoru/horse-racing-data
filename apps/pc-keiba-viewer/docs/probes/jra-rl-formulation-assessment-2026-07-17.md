...
- **Condition A-D definitions** (confirmed directly against
  `docs/architecture/finish-position-prediction-system.md` §11 and the four cited probe
  ...
  - §11 (`docs/architecture/finish-position-prediction-system.md:1267-1269`) literally
